            ...
            steps{
        		...
        		script{
        		   ...
        		   env.DOCKER_EXEC = "${DOCKER}/bin/docker"
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:0.0.0.0" --user $(id -u):$(id -g) -v $(pwd)/reports:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-full-scan.py -t "http://zero.webappsecurity.com" -I -r zap_baseline_report.html -l PASS'	
